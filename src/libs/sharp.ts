...
//   const optimizedFilePath = `./temp-files/optimized/optimized-${folder}-${crypto.randomUUID()}.avif`;
//   const originalFilePath = `./temp-files/original/original-${folder}-${crypto.randomUUID()}.avif`
//   try {
//       await sharp(file)
//         .resize({
//           width: 55,
